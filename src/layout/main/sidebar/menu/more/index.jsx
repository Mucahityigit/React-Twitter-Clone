    ...
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
        <button className="px-4 h-14 w-full inline-flex items-center gap-5 transition-colors hover:bg-[#eff3f41a]">
          ...
          <div className="text-xl pr-4 font-bold">Bağlan</div>
        </button>
        <button className="px-4 h-14 w-full inline-flex items-center gap-5 transition-colors hover:bg-[#eff3f41a]">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
              <path
                fill="#e7e9ea"
                d="M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9
                3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0 1.1.9 2 2
                2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4
                4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0
                4h2c0-1.1-.9-2-2-2v2z"
              />
            </svg>
          </div>
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="text-gray-500">
                <Link
                  to="/"
                  className="flex items-center px-3 h-11 gap-3 text-[15] font-medium hover:bg-[#eff3f41a] transition-colors text-white"
                >
                  <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                    <path
                      fill="#e7e9ea"
                      d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248
                    0v-7h2v7h-2z"
                    />
                  </svg>
                  İstatistikler
